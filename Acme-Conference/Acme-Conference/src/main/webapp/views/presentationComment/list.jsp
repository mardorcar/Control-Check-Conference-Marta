...
<display:table pagesize="5" name="comments" id="comment"
	...
	<display:column titleKey="comment.show" ><acme:button url="presentation/comment/show.do?commentId=${comment.id}" code="comment.show"/></display:column>
	
</display:table>

<acme:button url="presentation/comment/create.do?presentationId=${presentationId}" code="comment.write"/>
